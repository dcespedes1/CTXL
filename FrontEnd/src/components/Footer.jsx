...
const Footer = () => {
    return (
        <footer className="bg-[#3e2a8a] text-white py-8 mt-4"> {/* Color más oscuro */}
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                {/* Desarrolladores */}
                <div className="mb-8 text-center">
                    <h3 className="text-xl font-bold mb-4">Desarrolladores</h3>
                    <p className="mb-2">Desarrollado por el equipo de TextileUniforms</p>
                </div>

                {/* Redes Sociales */}
                <div className="mb-8">
                    <h3 className="text-xl font-bold mb-4 text-center">Redes Sociales</h3>
